  ...
  >
    <div className="flex items-center">
      <div className="h4 font-bold leading-snug tracking-tight mb-1">
        <span className="bg-clip-text">{text}</span> {subText}
      </div>
    </div>
        ...
        <div className="pt-6 md:pt-20">
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">
              Unique your helpdesk concept? <span className="font-source-serif-4 block font-normal text-orange-600">WonderSites can support it.</span>
            </h1>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              <div className="grid gap-4 mb-8 md:mb-0">
                <TabButton tabIndex={1} text="Customer Support" subText="Desk" currentTab={tab} setTab={setTab} />
                <TabButton tabIndex={2} text="IT Service" subText="Desk" currentTab={tab} setTab={setTab} />
                <TabButton tabIndex={3} text="Internal" subText="Helpdesk" currentTab={tab} setTab={setTab} />
                <TabButton tabIndex={4} text="Other" subText="Helpdesks" currentTab={tab} setTab={setTab} />
              </div>
            </div>
