      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        <div className="pt-6 sm:pt-8 md:pt-12 pb-8 sm:pb-10 md:pb-12">
          ...
          <div className="text-center px-2 sm:px-4 md:px-6 lg:px-8 grid">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-900 mb-2 sm:mb-2 font-lato max-w-2xl m-auto px-2 sm:px-0 leading-relaxed" style={{ textWrapStyle: 'balance' }}>
