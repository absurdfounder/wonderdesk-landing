...
const ProductHuntBadge = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122 37" className="w-48">
...
const NotionLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="12 0.19 487.619 510.941" className="w-12 h-12 mr-2 sm:w-10 sm:h-10">
