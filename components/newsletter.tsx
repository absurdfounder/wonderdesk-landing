            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <form className="w-full lg:w-auto">
                  ...
                  <Link href="app.wondersites.co" className="btn text-dark text-2xl bg-orange-300 hover:bg-orange-700 hover:text-orange-100 w-full mb-4 sm:w-auto sm:mb-0 flex items-center justify-center" >Build site using AI</Link>
                  </div>
                  {/* Success message */}
