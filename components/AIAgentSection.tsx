...
export default function AIAgentSection({
  ...
  const demoCard = (
    <div
      className={`overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_24px_60px_-16px_rgba(15,23,42,0.18)] ring-1 ring-black/[0.04] ${
        embedded ? 'shadow-[0_18px_48px_-20px_rgba(15,23,42,0.22)]' : ''
      }`}
    >
      ...
      <div className={`flex flex-col bg-white ${embedded ? 'min-h-[420px]' : 'min-h-[480px] md:min-h-[540px]'}`}>
        <div
          ref={chatRef}
    ...
    <section className={demoOnly ? '' : 'bg-white'}>
      ...
      <div className="landing-grid-column bg-white">
        ...
        <div
          ...
          style={demoOnly ? undefined : { backgroundColor: HOME_FEATURE_PLAIN_BG }}
        >
