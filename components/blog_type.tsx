  ...
  >
    <div className="flex items-center">
      <div className="h4 font-bold leading-snug tracking-tight mb-1">
        <span className="bg-clip-text">{text}</span> Blog
      </div>
    </div>
...
export default function Blog_Type() {
  ...
  return (
    <section id="blog-section" className="relative mt-4 mb-4 pb-4">
        ...
        <div className="pt-6 md:pt-20">
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">
              Unique your blog concept? <span className="font-source-serif-4 block font-normal text-orange-600">WonderSites can support it.</span>
            </h1>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              <div className="grid gap-4 mb-8 md:mb-0">
                <TabButton tabIndex={1} text="Personal" currentTab={tab} setTab={setTab} />
                <TabButton tabIndex={2} text="Company" currentTab={tab} setTab={setTab} />
                <TabButton tabIndex={3} text="Industry-Specific" currentTab={tab} setTab={setTab} />
