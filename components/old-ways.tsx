          ...
          <section className="w-full bg-slate-900 rounded-2xl py-8 sm:py-12 px-4 sm:px-6 mt-12 mb-12">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 text-white">
                ...
                <span className="font-source-serif-4 block font-normal text-orange-600 mt-2">
                  Skip the Setup Hell
                </span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-xl mx-auto px-4">
              <Link 
                ...
                className="w-full sm:w-auto px-6 py-3 text-lg sm:text-xl bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors duration-300 text-center"
              >
                Start from 98% Ready
              </Link>
              <Link 
