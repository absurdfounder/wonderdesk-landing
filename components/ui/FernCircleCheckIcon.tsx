type FernCircleCheckIconProps = {
  className?: string;
  size?: number;
};

/** Ferndesk-style filled circle + checkmark (not Lucide stroke). */
export default function FernCircleCheckIcon({
  className = 'text-lime-600',
  size = 16,
}: FernCircleCheckIconProps) {
  return (
    <svg
