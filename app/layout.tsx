...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.variable} ${robotoMono.variable} ${sourceSerif4.variable} ${comfortaa.variable} ${josefinSlab.variable} ${silkscreen.variable} ${bungee.variable} ${funneldisplay.variable} bg-white font-inter antialiased text-slate-900 tracking-tight`}>
