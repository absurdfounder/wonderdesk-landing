...
export const metadata = {
    ...
    description:
        "Build a marketplace in Notion, with our Notion marketplace maker. Go live in under a minute.  Build your free WonderSites marketplace website in a minute!",
        openGraph: {
            images: [
                {
...
export default function PageDetail() {
  ...
  <p className="max-w-md mx-auto mt-3 text-base text-slate-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
    WonderSites is the perfect tool for creating your marketplaces powered by Notion. You write your articles in Notion and WonderSites takes care of the rest. It's as simple as that.
  </p>
