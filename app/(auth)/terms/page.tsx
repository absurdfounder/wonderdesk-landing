...
export const metadata = {
    title: 'Wonder Sites Terms',
    description: 'Wonder Sites Terms of Use',
    alternates: {
                ...
                <div className="pt-12 pb-6 md:pt-4 md:pb-6">
                    ...
                    <div className="w-full px-8 sm:px-0 py-16 m-auto !prose">
                        <main className="notion bg-gray-50">
                            ...
                            <p className="text-slate-600 my-2">
                                <span><span>If you are unsatisfied with our services, please email us at&nbsp;vaibhav@wondersites.co</span></span>
                            </p>
                            <h2 className="h4 my-2">
