...
export default function PageDetail() {
  ...
  <p className="max-w-md mx-auto mt-3 text-base text-slate-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
    Wonderis the perfect tool for creating your knowledge bases powered by Notion. You write your articles in Notion and Wondertakes care of the rest. It's as simple as that.
  </p>
