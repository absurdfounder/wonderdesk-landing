              ...
              <div className="flex flex-col md:flex-row items-center w-full p-6">
                ...
                <div className="md:w-3/4 md:pl-6">
                  ...
                  <div className="mt-4 flex items-center">
                    <span className="inline-flex items-center px-2.5 py-1.5 rounded-md text-sm font-medium bg-orange-500 text-white transition-colors duration-200 group-hover:bg-orange-600">
                      Ask Us to Build
