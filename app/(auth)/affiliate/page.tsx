...
refer to WonderSites, without limits. Join
    ...
    <div className="max-w-md mx-auto text-center">
        ...
        <div className="mt-8"><Link href="https://WonderSites.lemonsqueezy.com/affiliates" target="_blank" className="btn text-slate-900 bg-slate-200 hover:bg-slate-600 w-full mb-4 sm:w-auto sm:mb-0">Become our partner</Link></div>
    </div>
</div>
