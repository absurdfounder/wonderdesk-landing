...
export const metadata = {
  ...
  description: 'Join the Wonderaffiliate program to become our partner. Spread the website builder and earn money with us.',
  openGraph: {
    images: [
        {
        ...
        our affiliate program today and start earning money.
          ...
          <div className="flex mx-auto px-4 py-8 mt-8">
            ...
            <div className="w-full lg:w-1/2 p-8 m-auto">
              ...
              <p className="text-md mt-4 mb-4 text-slate-800">Demonstrate your industry knowledge by recommending Wonderto your clients and fellow marketers. This will help you create an additional revenue source for your business. "Diversification is the key to financial resilience." — Warren Buffett.</p>
            </div>
          </div>
              ...
              <div className="mt-8">
                <div className="space-y-6">
                  <div className='p-8 border rounded-2xl border-slate-600'>
                    <h3 className="font-bold text-xl">Who is Wonderfor?</h3>
                    <br />
                    <p className="text-md mt-4 mb-4 text-slate-800">Wonderis a quick business builder for startup founders. Our users can quickly Get a beautiful web apps, blogs, and helpdesks for a mobile or desktop, for a SaaS product, for a plugin, an open-source project, a SMM tool etc.</p>
                    <p className="text-md mt-4 mb-4 text-slate-800">If your audience are tech guys, Wonderis for them. They will be more willing to use a tailored tool for startups rather than generic old-fashioned Webflow or Wordpress.</p>
                  </div>
                  ...
                  <div className='p-8 border rounded-2xl border-slate-600'>
                    ...
                    <p className="text-md mt-4 mb-4 text-slate-800">This is why startup founders love Wondermore than other tools.</p>
