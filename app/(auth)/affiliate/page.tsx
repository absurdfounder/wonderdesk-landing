...
export const metadata = {
  ...
  description: 'Join the WonderSites affiliate program to become our partner. Spread the website builder and earn money with us.',
  openGraph: {
    images: [
        {
...
refer to WonderSites, without limits. Join
        our affiliate program today and start earning money.
          ...
          <div className="max-w-sm mx-auto items-start md:max-w-2xl lg:max-w-none mt-20">
            ...
            <div className="py-12">
              ...
              <div className="mt-8">
                <ul className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
                  <li className="flex flex-col items-center">
                    ...
                    <div className="mt-4 text-center">Join WonderSites's affiliate program, grab your unique link and share it.</div>
                  </li>
                  <li className="flex flex-col items-center">
                    <div className="relative">
              ...
              <div className="mt-8 text-center">
                <Link href="https://boringsites.lemonsqueezy.com/affiliates" target="_self" className="btn text-dark text-2xl bg-orange-300 hover:bg-orange-700 hover:text-orange-100 w-full mb-4 sm:w-auto sm:mb-0 flex items-center justify-center">Become our Partner</Link>
              </div>
            </div>
          ...
          <div className="flex mx-auto px-4 py-8 mt-8">
            ...
            <div className="w-full lg:w-1/2 p-8 m-auto">
              ...
              <p className="text-md mt-4 mb-4 text-slate-800">Demonstrate your industry knowledge by recommending WonderSites to your clients and fellow marketers. This will help you create an additional revenue source for your business. "Diversification is the key to financial resilience." — Warren Buffett.</p>
            </div>
          </div>
              ...
              <div className="mt-8">
                <div className="space-y-6">
                  <div className='p-8 border rounded-2xl border-slate-600'>
                    <h3 className="font-bold text-xl">Who is WonderSites for?</h3>
                    <br />
                    <p className="text-md mt-4 mb-4 text-slate-800">WonderSites is a quick business builder for startup founders. Our users can quickly Get a beautiful web apps, blogs, and helpdesks for a mobile or desktop, for a SaaS product, for a plugin, an open-source project, a SMM tool etc.</p>
                    <p className="text-md mt-4 mb-4 text-slate-800">If your audience are tech guys, WonderSites is for them. They will be more willing to use a tailored tool for startups rather than generic old-fashioned Webflow or Wordpress.</p>
                  </div>
                  ...
                  <div className='p-8 border rounded-2xl border-slate-600'>
                    ...
                    <p className="text-md mt-4 mb-4 text-slate-800">This is why startup founders love WonderSites more than other tools.</p>
    ...
    <div className="max-w-md mx-auto text-center">
        <h2 className="h2 font-bold">Start earning cash by referring customers to WonderSites</h2>
        <br />
