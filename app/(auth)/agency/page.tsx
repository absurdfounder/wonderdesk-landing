...
export const metadata = buildPageMetadata({
  ...
  description: "Deploy Wonderdesk help centers and knowledge bases for agency clients.",
                ...
                <div className="pt-12 pb-6 md:pt-4 md:pb-6">
                    ...
                    <div className="max-w-4xl py-6 mx-auto lg:py-6">
                        ...
                        <div className="text-center">
                            <h1 className="md:text-5xl font-bold tracking-tight text-slate-900 sm:text-4xl font-display font-extrabold leading-tighter tracking-tighter mb-4 aos-init aos-animate"><span className="gradient-text-accent">Hire a Wonder  Expert</span> to help you grow beyond the limitations.</h1>
